...
- (IBAction)setInitialView:(id)sender;
...
- (void)viewDidLoad {    
    ...
    PFObject *testObject = [PFObject objectWithClassName:@"iOS"];
    [testObject setObject:@"ios" forKey:@"ios"];
    [testObject save];
    NSLog(@"Saved!");
     */
}
...
- (IBAction)setInitialView:(id)sender {
     ...
     CategoriasViewController *pCategorias      = [mainStoryboard instantiateViewControllerWithIdentifier:@"categoriasViewController"];
    
    
     pCategorias.modalPresentationStyle  = UIModalPresentationFullScreen;
     pCategorias.modalTransitionStyle    = UIModalTransitionStyleFlipHorizontal;
